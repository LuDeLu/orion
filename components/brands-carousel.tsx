        ...
        <div className="relative">
          ...
          <div ref={scrollRef} className="flex gap-16 overflow-hidden py-8" style={{ scrollBehavior: "auto" }}>
            {[...brands, ...brands].map((brand, index) => {
              ...
              const containerClass = "flex-shrink-0 w-56 h-32 flex items-center justify-center bg-background/40 backdrop-blur-sm border border-foreground/10 rounded-2xl grayscale hover:grayscale-0 transition-all duration-500 opacity-80 hover:opacity-100 hover:border-primary/40 hover:shadow-xl hover:shadow-primary/10";
